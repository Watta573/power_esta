...
import { Lock, Eye, EyeOff, CheckCircle2, AlertCircle, CheckCircle } from "lucide-react";
...
export default function ResetPasswordPage() {
  ...
  const mutation = useMutation({
    ...
    onError: () => toast.error("Le lien est invalide ou a expiré"),
  });
        ...
        >
          ...
          <div className="flex justify-center">
            <div className="rounded-full bg-[#d8f3dc] p-4">
              <Lock size={32} className="text-[#1b4332]" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                } py-3 pl-10 pr-12 focus:border-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#1b4332]`}
              />
              <button
                type="button"
